...
# URLs for the data
urls = {
    "documents": "https://pericom.epik.live/api/v4/documents/",
    "cabinets": "https://pericom.epik.live/api/v4/cabinets/",
    "tags": "https://pericom.epik.live/api/v4/tags/",
    "groups": "https://pericom.epik.live/api/v4/groups/",
    "metadata_types": "https://pericom.epik.live/api/v4/metadata_types/"
}

# Basic Authentication
auth = HTTPBasicAuth('admin', 'jJHPeUMJd9u5$hRuH9sj')
...
# Tính toán tổng số loại tài liệu (loại tài liệu duy nhất)
    ...
    index_url = "https://pericom.epik.live/api/v4/index_instances/"
    auth = HTTPBasicAuth('admin', 'jJHPeUMJd9u5$hRuH9sj')
